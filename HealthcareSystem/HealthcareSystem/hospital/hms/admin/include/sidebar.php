							...
							<li>
								<a href="javascript:void(0)">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title"> Health Personnel </span><i class="icon-arrow"></i>
										</div>
									</div>
								</a>
								<ul class="sub-menu">
									...
									<li>
										<a href="add-doctor.php">
											<span class="title"> Add Health Personnel </span>
										</a>
									</li>
									<li>
										<a href="Manage-doctors.php">
											<span class="title"> Manage Health Personnel </span>
										</a>
									</li>
	...
	<li>
								<a href="doctor-logs.php">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title"> Health Personnel Session Logs </span>
										</div>
									</div>
								</a>
							</li>		
